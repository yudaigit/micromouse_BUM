...
void controlInterrupt(void)
{
  ...
  if (g_speed_r > g_max_speed_r) {
    g_speed_r = g_max_speed_r;
  }
  if (g_speed_l > g_max_speed_l) {
    g_speed_l = g_max_speed_l;
  }
  if (g_speed_r < g_min_speed_r) {
    g_speed_r = g_min_speed_r;
  }
  if (g_speed_l < g_min_speed_l) {
    g_speed_l = g_min_speed_l;
  }
  ...
  if (g_con_wall.enable == true) {
    ...
    g_con_wall.control = 0.001 * g_speed_r * g_con_wall.kp * g_con_wall.error;
    spd_r = g_speed_r + g_con_wall.control;
    spd_l = g_speed_l - g_con_wall.control;
  } else {
    spd_r = g_speed_r;
    spd_l = g_speed_l;
  }
